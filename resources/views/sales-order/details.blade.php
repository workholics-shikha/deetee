...
<div class="main-content-area">
    ...
    <div class="main-content">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="d-flex align-items-center">
                                        <span class="table-square-icon bg-F0F5F6 rounded-3 me-2"
                                ...
                                <div class="col-12 col-md-6 text-md-end mt-2 mt-md-0">
                                    <button type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight"
                                        aria-controls="offcanvasRight" data-type="productList"
                                        data-id="{{ route('admin.product-list-sheet-preview', ['id' => $data->so_id]) }}"
                                        class="btn bg-F0F5F6 border rounded-3 text-0D161A showPreview">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <span class="table-square-icon rounded-3 img-zoom">
                                                    <img width="40" height="40" viewbox="0 0 12 12" fill="none"
                                                        src="{{ $item['so_product_qr_code'] }}" alt="Machine">
                                                </span>
                                                <span class="ps-2"> <a
                                        ...
                                        <div class="row">
                                            <div class="col-4">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <h6 class="text-0D161A fw-semibold"> {{ !empty($item['size1']) ?
                                                        $item['size1'] : '-' }} </h6>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-6 col-md-3 mb-2 mb-md-0">
                                                ...
                                                <div class="col-4 col-md-4">
                                                    ...
                                                    <button type="button" data-bs-toggle="offcanvas" id="showPDFPreview"
                                                        {{ $btnDisable }}
                                                    ...
                                                    <div class="col-8 col-md-8">
                                                        ...
                                                        <button
                                                            ...
                                                            <a class="showModal " data-bs-toggle="modal"
                                                                data-id="{{ $item['id'] }}"
                                                                data-bs-target="#exampleModal"> Select Sub-Product </a>
                                                            @else
                                                            @if ($item['measureunit'] == 'SET')
                                                            <a href="{{ route('admin.pass-sheet', $item['id']) }}"
                                                                style="{{ $btnDisable }}"> Pass sheet details </a>
                                                            @else
        ...
        $(document).on("click", ".printProductsButton", function() {
            var dataId = $("#searchInput").data("id");
            var currentUrl = "{{ URL('admin/printProductList/') }}/" + dataId;
            window.open(currentUrl, '_blank');
        });
        

        $(document).on("click", ".showPreview", function() { //alert('');
            ...
            } else if(btnType == 'productList') {
                $('.printBtn').html(
                    '<button class="btn bg-0199E5 text-white rounded-3 px-5 printProductsButton"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="18" viewBox="0 0 18 16" fill="none" class="me-1"> <path d="M13.9993 3.83333H3.99935V0.5H13.9993V3.83333ZM13.9993 8.41667C14.2355 8.41667 14.4334 8.33681 14.5931 8.17708C14.7528 8.01736 14.8327 7.81944 14.8327 7.58333C14.8327 7.34722 14.7528 7.14931 14.5931 6.98958C14.4334 6.82986 14.2355 6.75 13.9993 6.75C13.7632 6.75 13.5653 6.82986 13.4056 6.98958C13.2459 7.14931 13.166 7.34722 13.166 7.58333C13.166 7.81944 13.2459 8.01736 13.4056 8.17708C13.5653 8.33681 13.7632 8.41667 13.9993 8.41667ZM12.3327 13.8333V10.5H5.66602V13.8333H12.3327ZM13.9993 15.5H3.99935V12.1667H0.666016V7.16667C0.666016 6.45833 0.909071 5.86458 1.39518 5.38542C1.88129 4.90625 2.47157 4.66667 3.16602 4.66667H14.8327C15.541 4.66667 16.1348 4.90625 16.6139 5.38542C17.0931 5.86458 17.3327 6.45833 17.3327 7.16667V12.1667H13.9993V15.5Z" fill="#FFFFFF" /> </svg> Print </button>'
                );
            } else {
                $('.printBtn').html(
