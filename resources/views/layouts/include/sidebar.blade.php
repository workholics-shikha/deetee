<div class="sidebar sidebar-desktop d-none d-lg-block bg-white">
    <nav class="nav nav-pills flex-column">
        ...
        <a class="flex-sm-fill text-start nav-link mb-2 {{ in_array(request()->segment(2), ['sales-order', 'sales-order-details', 'route-card-details']) ? 'active' : '' }}" aria-current="page" href="{{ route('admin.sales-order') }}">
            <span class="sidebar-icon">
        ...
        <a class="flex-sm-fill text-start nav-link mb-2 {{ in_array(request()->segment(2), ['operations']) ? 'active' : '' }}" aria-current="page" href="{{ route('admin.operations') }}" >
            <span class="sidebar-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="20" viewBox="0 0 16 18"
                    fill="none">
                    <path
