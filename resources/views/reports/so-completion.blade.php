@section('title', 'Report-Sale Order Completion Tracking')
@extends('layouts.app')
@section('content')
                            ...
                            <div class="col-12 col-lg-6 border-end">
                                <div class="d-flex justify-content-between mb-3 mb-lg-0">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span class="text-0D161A fw-semibold me-1">{{$soCompletionTracking->total() }}</span>
                                ...
                                <form method="GET" action="{{ url()->current() }}"> 
                                    <div class="row">
                                            ...
                                            <div class="pe-0 pe-lg-4">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-lg-4 d-flex align-items-center mb-lg-0 mb-3">
                                                        <input type="date" name="from_date" class="form-control" required id="from_date" value="{{ request('from_date') ?? \Carbon\Carbon::parse($fromDate)->format('Y-m-d') }}">
                                                    </div>
                                                    <div class="col-12 col-lg-4 d-flex align-items-center mb-lg-0 mb-3">
                                                        <input type="date" name="to_date" class="form-control" required id="to_date" value="{{request('to_date') ?? \Carbon\Carbon::parse($toDate)->format('Y-m-d') }}">
                                                    </div>
                                                    <div class="col-12 col-lg-4 d-flex align-items-center mb-lg-0 mb-3">
                                        ...
                                        <div class="col-12 col-xl-2 d-flex align-items-center mt-4">
                                            ...
                                            <a href="{{ url()->current() }}" class="btn btn-skyBlue btn-sm rounded-2" title="Reset">Reset</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <table class="table rounded-3 mb-0" id="myTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" class="text-6C7D83 py-2 px-3 text-center"> Size1</th>
                                                <th scope="col" class="text-6C7D83 py-2 px-3 text-center"> Size2</th>
                                                <th scope="col" class="text-6C7D83 py-2 px-3 text-center"> Size3</th>
                                                <th scope="col" class="text-6C7D83 py-2 px-3 text-left"> Hardness</th>
                                                <th scope="col" class="text-6C7D83 py-2 px-3 text-left"> Material</th>
                                                <th scope="col" class="text-6C7D83 py-2 px-3"> SO <br> Quanity </th>
                                                <th scope="col" class="text-6C7D83 py-2 px-3"> SO <br> Start <br> Date </th>
