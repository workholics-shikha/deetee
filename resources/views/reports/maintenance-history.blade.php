@section('title', 'Report-Maintenance History')
@extends('layouts.app')
@section('content')
                            ...
                            <div class="col-12 col-lg-6 border-end">
                                <div class="d-flex justify-content-between mb-3 mb-lg-0">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span class="text-0D161A fw-semibold me-1">{{$maintenanceHistory->total() }}</span>
                                        ...
                                        <div class="col-12 col-xl-10">
                                            <div class="pe-0 pe-lg-4">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <input type="hidden" id="searchInput" search-url="{{ route('admin.maintenance-history-page') }}">
