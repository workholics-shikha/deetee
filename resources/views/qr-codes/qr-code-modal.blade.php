<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
        <div class="modal-body p-4 pb-0">
            ...
            <p class="text-6C7D83 fw-light" style="font-size: 14px"> To modify the QR Code please choose from the actions
                below </p>
            <div class="container mt-4 mb-4">
                <img width="130px" height="80px" src="{{$qrCode}}" class="img-fluid d-block mx-auto" alt="Responsive Image" />
            </div>
        ...
        <div class="modal-footer d-flex justify-content-center border-0">
            <button type="button" class="btn btn-secondary close-button text-0D161A bg-F0F5F6 fw-semibold border mb-3 rounded-3 modalCloseBtn"
