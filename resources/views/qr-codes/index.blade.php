                            ...
                            <div class="col-12">
                                <div class="table-responsive">
                                                    ...
                                                    <th scope="row" class="p-3">
                                                        <div class="d-flex align-items-center">
                                                            <span
                                                                ...
                                                                data-bs-target="#exampleModal" data-type="Operations"
                                                                style="cursor: pointer">
                                                                <img width="30" height="30" viewBox="0 0 12 12"
                                                                    fill="none" src="{{ $record->operation_qr_code }}"
                                                                    alt="" class="me-2" />
                                                            </span>
                                                ...
                                                <tr>
                                                    <td class="p-3">
                                                        <div class="d-flex align-items-center">
                                                            <span
                                                                class="table-square-icon bg-F0F5F6 rounded-3 showModal"
                                                                data-bs-toggle="modal" data-id="{{ $operator->id }}"
                                                                data-bs-target="#exampleModal" data-type="Operator"
                                                                style="cursor: pointer">
                                                                <img width="30" height="30" viewBox="0 0 12 12"
                                                ...
                                                <tr>
                                                    <th scope="row" class="p-3">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="table-square-icon bg-F0F5F6 rounded-3 showModal"
                                                                data-bs-toggle="modal" data-id="{{ $machine->id }}"
                                                    ...
                                                    <td class="p-3">
                                                        <span
                                                            class="rounded-pill bg-D5FFCC px-2 py-1 text-success fw-bolder">{{
                                                            $machine->section }}</span>
                                                    </td>
                                                ...
                                                <tr class="p-3">
                                                    <th scope="row">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <span class="ps-2"> <a
                                                                    class="text-0D161A fw-semibold mb-0 text-decoration-none">{{
                                                                    $product->product->product_modified_name }}<br />
                                                                    <span class="text-445B64"
                                                                        style="font-size: 12px">#{{
                                                                        $product->product->erp_nomenclature }}
                                                                    </span></a>
                                                            </span>
                                                        </div>
                                                    </th>
                                    ...
                                    <div id="GenericQR" class="tabcontent" style="display: none;">
                                        ...
                                        <div class="offcanvas offcanvas-end w-50" tabindex="-1" id="offcanvasRight"
                                            ...
                                            <div class="offcanvas-header">
                                                <div class="me-auto d-flex">
                                                    <button type="button" class="border-0 bg-transparent ms-0 closePdf"
                                                ...
                                                <div class="printBtn">
                                                    <button class="btn bg-0199E5 text-white rounded-3 px-5 printButton">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="18"
                                                            viewBox="0 0 18 16" fill="none" class="me-1">
                                                            <path
                                        ...
                                        <div class="paginationQ d-flex justify-content-center" id="genericQR-paginate">
