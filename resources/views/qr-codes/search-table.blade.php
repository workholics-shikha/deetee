                ...
                <div class="d-flex align-items-center">
                    <span class="table-square-icon bg-F0F5F6 rounded-3 showModal" data-bs-toggle="modal"
                        ...
                        <img width="30" height="30" viewBox="0 0 12 12" fill="none"
                            src="{{ $operator->user_qr_code }}" alt="" class="me-2" />
                    </span>
                    <span class="ps-2">
                ...
                <th scope="row" class="p-3">
                    <div class="d-flex align-items-center">
                        <span class="table-square-icon bg-F0F5F6 rounded-3 showModal" data-bs-toggle="modal"
                            ...
                            style="cursor: pointer">
                            <img width="30" height="30" viewBox="0 0 12 12" fill="none"
                                src="{{ $record->operation_qr_code }}" alt="" class="me-2" />
                        </span>
        ...
        <tr>
            <th scope="row" class="p-3">
                <div class="d-flex align-items-center">
                    ...
                    <span class="table-square-icon bg-F0F5F6 rounded-3 showModal" data-bs-toggle="modal"
                        data-id="{{ $machine->id }}" data-bs-target="#exampleModal" data-type="Machine"
                        style="cursor: pointer">
                        <img width="30" height="30" viewBox="0 0 12 12" fill="none"
        ...
        <tr class="p-3">
            <th scope="row">
                <div class="d-flex align-items-center">
                    ...
                    <span class="ps-2"> <a
                            class="text-0D161A fw-semibold mb-0 text-decoration-none">{{ $product->product->erp_product }}<br />
                            <span class="text-445B64"
                                style="font-size: 12px">#{{ $product->product->erp_nomenclature }}</span></a>
                    </span>
                </div>
            </th>
