...
@section('content')
    ...
    <div class="main-content-area">
        ...
        <div class="">
            <h5 class="text-0077B3 fw-semibold mt-5 ms-3"> <i class="fa-solid fa-long-arrow-left me-1 text-637381"></i> Machines / 
                                ...
                                <div class="d-flex align-items-center">
                                    <select id="machineStatus" class="form-select form-select-sm w-auto"
                                        ...
                                        <option value="maintenance"
                                            {{ $machine->machine_status == 'maintenance' ? 'selected' : '' }}>
                                            Maintenance
                                        </option>
                                        <option value="in-working"
                                            {{ $machine->machine_status == 'in-working' ? 'selected' : '' }}>
                                            In Working
                                        </option>
                                        <option value="breakdown"
                                            {{ $machine->machine_status == 'breakdown' ? 'selected' : '' }}>
                                            Breakdown
                                        </option>
                                    </select>
                                        ...
                                        <div class="d-flex gap-md-3 gap-lg-4 justify-content-around">
                                            <div class="">
                                                <div class="pe-4">
                                                    ...
                                                    <h5 class="text-0D161A mb-0 fw-bolder"> {{ $machineActualRunTime ? round((float) $machineActualRunTime / 60) : 0 }} </h5>
                                                </div>
                                            </div>
                                            <hr class="vertcal-hr">
                                            <div class="">
                                                            ...
                                                            @foreach ($breakdowntime as $breakMain)
                                                                <tr>
                                                                    <td class="text-445B64 p-3">
                                                                        <div class="d-flexv align-items-center">
                                                                            <h6 class="text-445B64 mb-0">
                                                                                {{ $breakMain->start_date_time ? \Carbon\Carbon::parse($breakMain->start_date_time)->format('d M Y') : 'NA' }}
                                                                            </h6>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td class="text-445B64 p-3">
                                                                        <div class="">
                                                                            <h6 class="text-6C7D83 mb-0 fs-13">
                                                                                {{ $breakMain->start_date_time ? \Carbon\Carbon::parse($breakMain->start_date_time)->format('h:i a') : 'NA' }}
                                                                            </h6>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <!-- end time -->
                                                                    <td class="text-445B64 p-3">
                                                                        {{ $breakMain->end_date_time ? \Carbon\Carbon::parse($breakMain->end_date_time)->format('h:i a') : 'NA' }}
                                                                    </td>
