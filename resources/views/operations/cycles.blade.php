                    ...
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="col-6 col-md-3 mb-4 mb-md-0">
                            <div class="border-right pe-2 pe-lg-0">
                                <h6 class="text-445B64">Total Cycles</h6>
                                <h4 class="text-0D161A mb-0 fw-semibold">{{ $totalrecords }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-12 col-lg-4 d-flex align-items-center">
                                <div class="d-flex position-relative" style="width: -webkit-fill-available">
                                    <input class="form-control me-2 shadow-none"
                                        ...
                                        placeholder="Search" aria-label="Search" id="searchInput" search-url="{{route('admin.operations.index')}}"/>
                            ...
                            <div class="col-12">
                                <div class="table-responsive">
                                    <table class="table rounded-3" id="myTable">
                                        <thead>
                                            <tr>
                                                <th scope="col" class="text-445B64 p-3">S.No.</th>
                                                <th scope="col" class="text-445B64 p-3">
                                                    Name
                                                </th>
                                                <th scope="col" class="text-445B64 p-3">Created At</th>
                                            </tr>
                                        </thead>
                                        <tbody id="myTableBody">

                                            @include('admin/snippets/cycles')
